                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('customer_id') ? 'has-error' : ''}}">
                                        ...
                                        {!! Form::select('customer_id', $customers, null, ('' == 'required') ? ['class' => 'form-control customer', 'required' => 'required'] : ['class' => 'form-control customer']) !!}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('mobile_no') ? 'has-error' : ''}}">
                                        ...
                                        {!! Form::number('mobile_no', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required', 'readonly'=>'readonly', 'id' => 'customer_mobile'] : ['class' => 'form-control', 'readonly'=>'readonly', 'id' => 'customer_mobile']) !!}
